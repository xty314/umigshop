          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="site-footer__widget footer-contacts">
              ...
              <ul className="footer-contacts__contacts">
                <li><i className="footer-contacts__icon fas fa-globe-americas" /> 715 Fake Street,
                  New York 10021 USA</li>
                <li><i className="footer-contacts__icon far fa-envelope" /> stroyka@example.com
                </li>
                <li><i className="footer-contacts__icon fas fa-mobile-alt" /> (800) 060-0730,
                  (800) 060-0730</li>
                <li><i className="footer-contacts__icon far fa-clock" /> Mon-Sat 10:00pm - 7:00pm
                </li>
              </ul>
            </div>
          </div>
          <div className="col-6 col-md-3 col-lg-2">
            <div className="site-footer__widget footer-links">
              ...
              <ul className="footer-links__list">
                <li className="footer-links__item"><a href="#" className="footer-links__link">About
                    Us</a></li>
                <li className="footer-links__item"><a href="#" className="footer-links__link">Delivery
                    Information</a></li>
                <li className="footer-links__item"><a href="#" className="footer-links__link">Privacy
                    Policy</a></li>
